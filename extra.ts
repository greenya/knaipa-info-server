...
// { name: 'Штукар',                   desc: 'Найбільша кількість сокетів в предметах' },                   // ? char-equipment
// { name: 'Незруйновний',             desc: 'Найбільша кількість предметів з бонусом Indestructible' },    // ? char-equipment
